...
$f3->set('DEBUG',1);
$f3->set('version','2.7');
$f3->set('AUTOLOAD',__dir__.'/;libs/f3/;libs/;libs/WideImage/;daos/;libs/twitteroauth/;libs/FeedWriter/;libs/Epub;libs/PHPMailer');
...
$f3->route('GET /register',   'controllers\Index->register');    // json
